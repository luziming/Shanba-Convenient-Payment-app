...
public class SetPasswordFragment extends BaseFragment implements View.OnClickListener {
    ...
    public void onClick(View v) {
        ...
        params.put("org_code", ConstantUtil.SHANBA_ORG_CODE);
        appUtil.getRegInfo(params, new MyResponseHandler());
    ...
    private class MyResponseHandler extends JsonHttpResponseHandler {
        ...
        public void onSuccess(int statusCode, Header[] headers,
            ...
            try {
                ...
                if (!success) {
                    boolean exist = response.getString("error").contains(phone_number);
                    if (exist) {
                        ToastUtil.show(context, "已经注册过该账号！");
                        return;
                    }
                }
